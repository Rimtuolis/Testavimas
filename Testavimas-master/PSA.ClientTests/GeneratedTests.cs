...
{
    [TestClass()]
    public class GeneratedTests : BunitTestContext
    {
        ...
        public void AddToCartRobotIsNull()
        {
            ...
            mock.When("/api/autobuilder").RespondJson((Robot)null);
            mock.When("/api/currentuser").RespondJson(testUser);

            var cut = RenderComponent<Generated>();
        ...
        public async Task AddToCartTest()
        {
            ...
            var testRobot = _fixture.Build<Robot>().With(y => y.RightLeg, testRightLeg.Id)
                ...
                .Create();
            mock.When("/api/autobuilder").RespondJson(testRobot);
            mock.When("/api/currentuser").RespondJson(testUser);
